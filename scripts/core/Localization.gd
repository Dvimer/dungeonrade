...
const TEXTS := {
	"en": {
		...
		"menu.settings.sound_on": "On",
		"menu.settings.sound_off": "Off",
		...
		"crypt.skills.header": "Unlock skills (20 skulls) to add them to your run pool. Upgrade unlocked skills to make them stronger.",
		"crypt.skills.max_level": "MAX LEVEL",
		"crypt.skills.unlock": "🔓 Unlock  (%d skulls)",
		"crypt.skills.unlock_need": "🔒  %d skulls needed",
		"crypt.skills.in_pool": "✓ In pool",
		...
		"skill.gold_sweep.title": "Gold Sweep",
		"skill.gold_sweep.short": "Sweep",
		"skill.gold_sweep.desc": "Collect all gold from the board instantly.",
		"skill.gold_sweep.icon": "SWEEP",
		"skill.wrath.title": "Wrath",
		"skill.wrath.short": "Wrath",
		"skill.wrath.desc": "Deal sword damage to every enemy on the board.",
		"skill.wrath.icon": "WRATH",
		"skill.row_sweep.title": "Row Sweep",
		"skill.row_sweep.short": "Rows",
		"skill.row_sweep.desc": "Collect everything in the bottom two rows.",
		"skill.row_sweep.icon": "ROWS",
		"skill.full_heal.title": "Full Heal",
		"skill.full_heal.short": "Heal",
		"skill.full_heal.desc": "Restore HP to maximum.",
		"skill.full_heal.icon": "HEAL",
		"skill.stasis.title": "Stasis",
		"skill.stasis.short": "Stasis",
		"skill.stasis.desc": "Reset all enemy timers to their maximum.",
		"skill.stasis.icon": "STOP",
		"skill.predator.title": "Predator",
		"skill.predator.short": "Pred",
		"skill.predator.desc": "Your next chain is a guaranteed critical hit.",
		"skill.predator.icon": "CRIT",
	...
	"ru": {
		...
		"menu.settings.sound": "Звук",
		"menu.settings.sound_on": "Вкл",
		"menu.settings.sound_off": "Выкл",
		...
		"crypt.skills.header": "Разблокируй навыки (20 черепов) для добавления в пул. Прокачивай разблокированные навыки, чтобы усилить их.",
		"crypt.skills.max_level": "МАКС. УР.",
		"crypt.skills.unlock": "🔓 Разблокировать  (%d черепов)",
		"crypt.skills.unlock_need": "🔒  нужно %d черепов",
		"crypt.skills.in_pool": "✓ В пуле",
		...
		"skill.gold_sweep.title": "Золотой сбор",
		"skill.gold_sweep.short": "Злато",
		"skill.gold_sweep.desc": "Мгновенно собирает всё золото с доски.",
		"skill.gold_sweep.icon": "ЗЛАТО",
		"skill.wrath.title": "Гнев",
		"skill.wrath.short": "Гнев",
		"skill.wrath.desc": "Наносит урон мечом каждому врагу на доске.",
		"skill.wrath.icon": "ГНЕВ",
		"skill.row_sweep.title": "Зачистка рядов",
		"skill.row_sweep.short": "Ряды",
		"skill.row_sweep.desc": "Собирает всё из двух нижних рядов.",
		"skill.row_sweep.icon": "РЯДЫ",
		"skill.full_heal.title": "Полное лечение",
		"skill.full_heal.short": "Лечение",
		"skill.full_heal.desc": "Восстанавливает всё HP до максимума.",
		"skill.full_heal.icon": "ЛЕЧЕНИЕ",
		"skill.stasis.title": "Стазис",
		"skill.stasis.short": "Стазис",
		"skill.stasis.desc": "Сбрасывает таймеры всех врагов до максимума.",
		"skill.stasis.icon": "СТОП",
		"skill.predator.title": "Хищник",
		"skill.predator.short": "Хищник",
		"skill.predator.desc": "Следующая цепочка — гарантированный крит.",
		"skill.predator.icon": "КРИТ",
